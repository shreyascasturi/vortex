...
// Generated at 2021-11-12 12:04:18.482432
...
// PERF: memory
#define CSR_MPM_MEM_READS           0xB19     // memory reads
#define CSR_MPM_MEM_READS_H         0xB99
#define CSR_MPM_MEM_WRITES          0xB1A     // memory writes
#define CSR_MPM_MEM_WRITES_H        0xB9A
#define CSR_MPM_MEM_ST              0xB1B     // memory request stalls
#define CSR_MPM_MEM_ST_H            0xB9B
#define CSR_MPM_MEM_LAT             0xB1C     // memory latency (total)
...
#define CSR_TEX_WRAP(x)     (CSR_TEX_BEGIN(x) + 0x02)
#define CSR_TEX_FILTER(x)   (CSR_TEX_BEGIN(x) + 0x03)
#define CSR_TEX_MIPOFF(x)   (CSR_TEX_BEGIN(x) + 0x04)
#define CSR_TEX_WIDTH(x)    (CSR_TEX_BEGIN(x) + 0x05)
#define CSR_TEX_HEIGHT(x)   (CSR_TEX_BEGIN(x) + 0x06)
